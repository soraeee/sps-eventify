	...
	return (
		<div class="flex h-[80%] flex-row bg-white ">
			<div class="w-[45%] flex flex-col ml-9">
				<div class="gap-2 flex flex-col h-[50%] mt-28 font-medium text-5xl text-[#2CB67D] drop-shadow-lg z-0">
					<div>Your all-in-one</div>
					<div>campus experience</div>
					<div>platform</div>
				</div>
				<div class="h-[24%] text-xl w-[80%] z-10">
					{' '}
				...
				<div class="h-[10%] z-0">
					<div class="bg-[#5BD7A4]/10 h-[450px] w-[900px] mt-[-380px] ml-[-60px]" />
				</div>
			</div>
			<div class="w-[50%] ">
